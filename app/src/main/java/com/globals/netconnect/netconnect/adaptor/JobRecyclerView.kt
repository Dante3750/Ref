...
import com.globals.netconnect.netconnect.adaptor.JobRecyclerView.MyViewHolder
import com.globals.netconnect.netconnect.model.Job

class JobRecyclerView(regular: Typeface,latoSemiBold: Typeface,private val List: List<Job>) :
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): MyViewHolder {
        val itemView = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.ietm_job_list, viewGroup, false)
